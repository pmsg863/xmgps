...
(function (ja) {
    var w, l, r = function (a, b) {
        if ("function" === typeof document.addEventListener || d.isIE8()) {
            ...
            var f = this, g = f.classes, k = f.settings = d.merge(f.defaults, {attachTo: a}, b || {}), e = f.container = d.make("div", {"class": g.container}), r = f.calendars = [], p = l().day(k.weekStart), u, v = [], m, q, B, w;
            m = [];
            var D;
            q = 0;
            u = k.months;
            d.isIE8() && d.addClassName(e, "ie8");
            for (q = 7; q--;)v.push(p.format(k.columnHeaderFormat)), p.add("days",
                1);
            F(f);
            ...
            (u = {past: k.months - 1, "today-past": k.months - 1, any: 2 < k.months ? Math.floor(k.months / 2) : 0, "today-future": 0, future: 0}[this.settings.direction]) && l().month() == l(f.viewStartDate).month() && (f.viewStartDate = l(f.viewStartDate).subtract({M: u}).date(1));
            if ("function" === typeof k.blackout)f.blackout = k.blackout; else if (k.blackout) {
            ...
            for (u = Math.max(k.months, 1); u--;) {
                m = d.make("div", {"class": g.calendar}, e);
                ...
                q = d.make("div", {"class": g.title}, m);
                k.useYearNav || d.addClassName(q, g.disableYearNav);
                d.make("a", {"class": g.previousYear}, q);
                d.make("a", {"class": g.previousMonth}, q);
                d.make("a", {"class": g.nextYear}, q);
                d.make("a", {"class": g.nextMonth}, q);
                p = d.make("span", {"class": g.caption}, q);
                B = d.make("div", {"class": g.header}, m);
                q = 0;
                do D = d.make("span", {}, B), D.innerHTML = v[q]; while (7 > ++q);
                B = d.make("div", {"class": g.days}, m);
                q = 0;
                m = [];
                do"week" == k.mode ? (0 === q % 7 && (w = d.make("div", {"class": g.week + " clearfix"}, B), m.push(w)), d.make("span", {}, w)) : m.push(d.make("span", {}, B)); while (42 > ++q);
                r.push({caption: p, days: m});
                u && d.make("div", {"class": g.monthSeparator}, e)
            }
            f.draw();
            d.addEvent(e, "mousedown", function (a, e) {
                var b;
                if (d.hasClassName(e, g.nextMonth))f.disableNext || !1 === f.publish("view-changed", f, ["next-month"]) || (f.viewStartDate.add("months", 1), f.draw()); else if (d.hasClassName(e, g.previousMonth))f.disablePreviousMonth ||
                    ...
                    g.dayActive) && (b = e.getAttribute("data-date"))) {
    ...
    r.prototype = {defaults: {attachTo: null, months: 1, weekStart: 0, direction: "any", directionScrolling: !0, viewStartDate: null, blackout: null, selected: null, mode: "single", dayOutOfMonthClickable: !1, format: null, subscribe: null, columnHeaderFormat: "dd", titleFormat: "MMMM, YYYY", dayNumberFormat: "D", dayAttributeFormat: "YYYY-MM-DD", parseSplitDelimiter: /,\s*|\s+-\s+/, rangeDelimiter: " - ", multipleDelimiter: ", ", useYearNav: !0, dateClassMap: {}}, classes: {container: "kalendae", calendar: "k-calendar",
        ...
        disableNextMonth: "k-disable-next-month-btn", disablePreviousYear: "k-disable-previous-year-btn", disableNextYear: "k-disable-next-year-btn", disableYearNav: "k-disable-year-nav"}, disablePreviousMonth: !1, disableNextMonth: !1, disablePreviousYear: !1, disableNextYear: !1, directions: {past: function (a) {
        ...
        return l(a).startOf("day").yearDay() <
            w.yearDay()
    }, future: function (a) {
        return l(a).startOf("day").yearDay() <= w.yearDay()
        ...
        switch (this.settings.mode) {
            case "week":
            case "range":
                var b = this._sel[0] ? this._sel[0].startOf("day").yearDay() : 0, e = this._sel[1] ? this._sel[1].startOf("day").yearDay() : 0;
                return b === a || e === a ? 1 : b && e ? a > b && a <
                    e || b < e && a < b && a > e ? -1 : !1 : 0;
            case "multiple":
        ...
        var e, d = z(a, this.settings.parseSplitDelimiter, this.settings.format), f = z(this.getSelected(), this.settings.parseSplitDelimiter, this.settings.format);
        for (e = f.length; e--;)this.removeSelected(f[e], !1);
        for (e = d.length; e--;)this.addSelected(d[e], !1);
        !1 !== b && (d[0] && (this.viewStartDate =
            l(d[0], this.settings.format)), this.draw())
        ...
        var b = a.toDate(), e = l(b).startOf("week"), b = l(b).endOf("week").subtract("day", 1);
        this._sel = [e, b];
        ...
        a = l(a, this.settings.format).hours(12);
        for (var e = this._sel.length; e--;)if (this._sel[e].startOf("day").yearDay() === a.startOf("day").yearDay())return this._sel.splice(e, 1), this.publish("change", this, [a]), !1 !== b && this.draw(), !0;
        return!1
    }, draw: function () {
        var a = l(this.viewStartDate).startOf("day").hours(12), b, e = this.classes, n, f, g, k = 0, r, p = 0, u, v, m = this.settings;
        r = this.calendars.length;
        do {
            b = l(a).date(1);
            b.day(b.day() < this.settings.weekStart ?
                this.settings.weekStart - 7 : this.settings.weekStart);
            n = this.calendars[k];
            n.caption.innerHTML = a.format(this.settings.titleFormat);
            u = p = 0;
            do"week" == m.mode ? (0 === p % 7 && 0 !== p && u++, f = n.days[u].childNodes[p % 7]) : f = n.days[p], g = [], (v = this.isSelected(b)) && g.push({"-1": e.dayInRange, 1: e.daySelected, "true": e.daySelected}[v]), b.month() != a.month() ? g.push(e.dayOutOfMonth) : g.push(e.dayInMonth), (!(this.blackout(b) || this.direction(b) || b.month() != a.month() && !1 === m.dayOutOfMonthClickable) || 0 < v) && g.push(e.dayActive), b.startOf("day").yearDay() ===
                w.yearDay() && g.push(e.dayToday), v = b.format(this.settings.dayAttributeFormat), m.dateClassMap[v] && g.push(m.dateClassMap[v]), f.innerHTML = b.format(m.dayNumberFormat), f.className = g.join(" "), f.setAttribute("data-date", v), b.add("days", 1); while (42 > ++p);
            a.add("months", 1)
        } while (++k < r);
        if (m.directionScrolling) {
            b = l().startOf("day").hours(12);
            a = a.diff(b, "months", !0);
            if ("today-past" === m.direction || "past" === m.direction)0 >= a ? (this.disableNextMonth = !1, d.removeClassName(this.container, e.disableNextMonth)) : (this.disableNextMonth = !0, d.addClassName(this.container, e.disableNextMonth)); else if ("today-future" === m.direction || "future" === m.direction)a > m.months ? (this.disablePreviousMonth = !1, d.removeClassName(this.container, e.disablePreviousMonth)) : (this.disablePreviousMonth = !0, d.addClassName(this.container, e.disablePreviousMonth));
    ...
    window.Kalendae = r;
    var d = r.util = {isIE8: function () {
        return!(!/msie 8./i.test(navigator.appVersion) ||
            /opera/i.test(navigator.userAgent) || !window.ActiveXObject || !XDomainRequest || window.msPerformance)
    }, $: function (a) {
        ...
        var e;
        a.currentStyle ? e = a.currentStyle[b] : window.getComputedStyle &&
            (e = (e = window.getComputedStyle(a, null)) ? e[b] : "");
        return e
    }, domReady: function (a) {
        ...
        a.detachEvent ? a.detachEvent("on" +
            b, e) : a.removeEventListener(b, e, !1)
    }, fireEvent: function (a, b) {
        if (document.createEvent) {
            var e = document.createEvent("HTMLEvents");
            e.initEvent(b, !1, !0);
            a.dispatchEvent(e)
        } else if (document.createEventObject)a.fireEvent("on" + b); else if ("function" == typeof a["on" + b])a["on" + b]()
    }, hasClassName: function (a, b) {
        if (!(a = d.$(a)))return!1;
        var e = a.className;
        return 0 < e.length && (e == b || RegExp("(^|\\s)" + b + "(\\s|$)").test(e))
    }, addClassName: function (a, b) {
        (a = d.$(a)) && !d.hasClassName(a, b) && (a.className += (a.className ? " " : "") +
            b)
    }, removeClassName: function (a, b) {
        if (a = d.$(a))a.className = d.trimString(a.className.replace(RegExp("(^|\\s+)" + b + "(\\s+|$)"), " "))
    }, isFixed: function (a) {
        do if ("fixed" === d.getStyle(a, "position"))return!0; while (a = a.offsetParent);
        return!1
        ...
        var e = a.offsetLeft, d = a.offsetTop, f = {};
    ...
    "function" === typeof document.addEventListener && r.util.domReady(function () {
        for (var a = d.$$(".auto-kal"), b = a.length, e, n; b--;)e = a[b], n = e.getAttribute("data-kal"), n = null == n || "" == n ? {} : (new Function("return {" + n + "};"))(), "INPUT" === e.tagName ? new r.Input(e, n) : new r(d.merge(n, {attachTo: e}))
    });
    r.Input = function (a, b) {
        if ("function" === typeof document.addEventListener || d.isIE8()) {
            var e = this.input = d.$(a), n, f, g = !1;
            if (!e || "INPUT" !== e.tagName)throw"First argument for Kalendae.Input must be an <input> element or a valid element id.";
            var k = this, l = k.classes;
            f = k.settings = d.merge(k.defaults, b);
            this._events = {};
            f.attachTo = window.document.body;
            f.selected ? n = !0 : f.selected = e.value;
            r.call(k, f);
            f.closeButton && (f = d.make("a", {"class": l.closeButton}, k.container), d.addEvent(f, "click", function () {
                e.blur()
            }));
            ...
            this._events.documentMousedown = d.addEvent(window.document,
    ...
    r.Input.prototype =
        d.merge(r.prototype, {defaults: d.merge(r.prototype.defaults, {format: "YYYY-MM-DD hh:mm:ss", side: "bottom", closeButton: !0, offsetLeft: 0, offsetTop: 0}), classes: d.merge(r.prototype.classes, {positioned: "k-floating", closeButton: "k-btn-close"}), show: function () {
            var a = this.container, b = a.style, e = this.input, n = d.getPosition(e), f = d.scrollContainer(e), f = f ? f.scrollTop : 0, g = this.settings;
            b.display = "";
            switch (g.side) {
                case "left":
            ...
            var a = this.container, b = this.input;
    ...
    (function (a) {
        ...
        function g(c) {
            var s = c.years || c.year || c.y || 0, a = c.months || c.month || c.M || 0, b = c.weeks || c.week || c.w || 0, e = c.days || c.day || c.d || 0, d = c.hours || c.hour || c.h || 0, f = c.minutes || c.minute || c.m || 0, h = c.seconds || c.second || c.s || 0, g = c.milliseconds || c.millisecond ||
                c.ms || 0;
            this._input = c;
        ...
        function r(c, s, a, b) {
            var e = s._milliseconds, d = s._days;
            s = s._months;
            var f, g;
        ...
        function v(c, s) {
            var a = Math.min(c.length, s.length), b = Math.abs(c.length - s.length), e = 0, d;
        ...
        function E(c, a, b) {
            ...
            b < a - 7 && (b += 7);
            c = h(c).add("d", b);
            return{week: Math.ceil(c.dayOfYear() / 7), year: c.year()}
        }
        ...
        function P(c) {
            ...
            if (h.isMoment(b))c = k({}, b), c._d = new Date(+b._d); else if (d)if ("[object Array]" === Object.prototype.toString.call(d)) {
                var b = c, e, g, l = 99, m;
                for (m = 0; m < b._f.length; m++)e = k({}, b),
                    e._f = b._f[m], G(e), d = new f(e), e = v(e._a, d.toArray()), d._il && (e += d._il.length), e < l && (l = e, g = d);
                k(b, g)
            } else G(c); else if (g = c, b = g._i, d = fa.exec(b), b === a)g._d = new Date; else if (d)g._d = new Date(+d[1]); else if ("string" === typeof b)if (b = g._i, d = ga.exec(b)) {
                g._f = "YYYY-MM-DD" + (d[2] || " ");
                ...
                I.exec(b) && (g._f += " Z");
                G(g)
            } else g._d = new Date(b); else"[object Array]" === Object.prototype.toString.call(b) ? (g._a = b.slice(0), L(g)) : g._d = b instanceof Date ? new Date(+b) : new Date(b);
            return new f(c)
        }
        ...
        for (var h, y = Math.round, t, A = {}, M = "undefined" !== typeof module && module.exports, fa = /^\/?Date\((\-?\d+)/i, ia = /(\-)?(\d*)?\.?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/, N = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,
                ...
                ["HH", /(T| )\d\d/]
                 ...
                 ea = /([\+\-]|\d\d)/gi, J = ["Date", "Hours", "Minutes", "Seconds", "Milliseconds"], K = {Milliseconds: 1, Seconds: 1E3, Minutes: 6E4, Hours: 36E5, Days: 864E5, Months: 2592E6, Years: 31536E6}, V = {ms: "millisecond", s: "second", m: "minute", h: "hour", d: "day", w: "week", M: "month", y: "year"}, H = {}, T = "DDD w W M D d".split(" "), U = "MDHhmswW".split(""), x = {M: function () {
                return this.month() + 1
            }, MMM: function (c) {
        ...
        d.prototype = {set: function (c) {
        ...
        }, _months: "January February March April May June July August September October November December".split(" "), months: function (c) {
            return this._months[c.month()]
        }, _monthsShort: "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), monthsShort: function (c) {
        ...
        }, _weekdays: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), weekdays: function (c) {
            return this._weekdays[c.day()]
        }, _weekdaysShort: "Sun Mon Tue Wed Thu Fri Sat".split(" "), weekdaysShort: function (c) {
            return this._weekdaysShort[c.day()]
        }, _weekdaysMin: "Su Mo Tu We Th Fr Sa".split(" "), weekdaysMin: function (c) {
            ...
            weekdaysParse: function (c) {
                ...
                (a = this._longDateFormat[c.toUpperCase()].replace(/MMMM|MM|DD|dddd/g, function (c) {
                    return c.slice(1)
                }), this._longDateFormat[c] = a);
                return a
            }, isPM: function (c) {
                return"p" === (c + "").toLowerCase()[0]
            }, _meridiemParse: /[ap]\.?m?\.?/i, meridiem: function (c, a, b) {
                return 11 < c ? b ? "pm" : "PM" : b ? "am" : "AM"
            }, _calendar: {sameDay: "[Today at] LT", nextDay: "[Tomorrow at] LT", nextWeek: "dddd [at] LT", lastDay: "[Yesterday at] LT", lastWeek: "[Last] dddd [at] LT", sameElse: "L"}, calendar: function (c, a) {
                var b = this._calendar[c];
                return"function" === typeof b ? b.apply(a) : b
            }, _relativeTime: {future: "in %s", past: "%s ago", s: "a few seconds", m: "a minute", mm: "%d minutes", h: "an hour", hh: "%d hours", d: "a day", dd: "%d days", M: "a month", MM: "%d months", y: "a year", yy: "%d years"}, relativeTime: function (c, a, b, d) {
                ...
                return this._ordinal.replace("%d",
                    c)
            }, _ordinal: "%d", preparse: function (c) {
                return c
        ...
        h = function (c, a, b) {
            return P({_i: c, _f: a, _l: b, _isUTC: !1})
        };
        h.utc = function (c, a, b) {
            return P({_useUTC: !0, _isUTC: !0, _l: b, _i: c, _f: a})
        };
        h.unix = function (c) {
            return h(1E3 * c)
        };
        h.duration = function (c, a) {
            var b = h.isDuration(c), d = "number" === typeof c, e = b ? c._input : d ? {} : c, f = ia.exec(c);
            d ? a ? e[a] = c : e.milliseconds = c : f && (d = "-" === f[1] ? -1 : 1, e = {y: 0, d: ~~f[2] * d,
                h: ~~f[3] * d, m: ~~f[4] * d, s: ~~f[5] * d, ms: ~~f[6] * d});
            f = new g(e);
        ...
        h.fn = f.prototype = {clone: function () {
            return h(this)
        }, valueOf: function () {
            ...
            isValid: function () {
                ...
                var b;
                b = "string" === typeof c ?
                    h.duration(+a, c) : h.duration(c, a);
                r(this, b, -1);
                return this
            }, diff: function (c, a, b) {
                c = this._isUTC ? h(c).zone(this._offset || 0) : h(c).local();
                var d = 6E4 * (this.zone() - c.zone()), e;
                a = m(a);
                "year" === a || "month" === a ? (e = 432E5 * (this.daysInMonth() + c.daysInMonth()), d = 12 * (this.year() - c.year()) + (this.month() - c.month()), d += (this - h(this).startOf("month") - (c - h(c).startOf("month"))) / e, d -= 6E4 * (this.zone() - h(this).startOf("month").zone() - (c.zone() - h(c).startOf("month").zone())) / e, "year" === a && (d /= 12)) : (e = this - c, d = "second" ===
                    a ? e / 1E3 : "minute" === a ? e / 6E4 : "hour" === a ? e / 36E5 : "day" === a ? (e - d) / 864E5 : "week" === a ? (e - d) / 6048E5 : e);
                return b ? d : l(d)
            }, from: function (c, a) {
                ...
                var c = this.diff(h().startOf("day"), "days", !0), c = -6 > c ? "sameElse" : -1 > c ? "lastWeek" : 0 > c ? "lastDay" : 1 > c ? "sameDay" : 2 > c ? "nextDay" : 7 > c ? "nextWeek" : "sameElse";
                ...
                return null != c ? "string" === typeof c && (c = this.lang().weekdaysParse(c), "number" !== typeof c) ? this : this.add({d: c - a}) : a
            }, month: function (a) {
                var b = this._isUTC ? "UTC" : "", d;
                if (null != a) {
                ...
                if (null != a)"string" === typeof a && (a =
                    C(a)), 16 > Math.abs(a) && (a *= 60), this._offset = a, this._isUTC = !0, b !== a && r(this, h.duration(b - a, "m"), 1, !0); else return this._isUTC ? b : this._d.getTimezoneOffset();
                return this
            }, zoneAbbr: function () {
                ...
                var b =
                    E(this, this.lang()._week.dow, this.lang()._week.doy).year;
                ...
                return null == a ? this.day() ||
                    7 : this.day(this.day() % 7 ? a : a - 7)
            }, lang: function (b) {
        ...
        h.duration.fn = g.prototype = {_bubble: function () {
            ...
            var b = +this, d;
            d = !a;
            var e = this.lang(), f = y(Math.abs(b) / 1E3), g = y(f / 60), h = y(g / 60), k = y(h / 24), l = y(k / 365), f = 45 > f && ["s", f] || 1 === g && ["m"] || 45 > g && ["mm", g] || 1 === h && ["h"] || 22 > h && ["hh", h] || 1 === k && ["d"] || 25 >= k && ["dd", k] || 45 >= k && ["M"] || 345 > k && ["MM", y(k /
                30)] || 1 === l && ["y"] || ["yy", l];
            f[2] = d;
            f[3] = 0 < b;
            f[4] = e;
    ...
    if (!r.moment)if (window.moment)r.moment = window.moment; else throw"Kalendae requires moment.js. You must use kalendae.standalone.js if moment is not available on the page.";
    l = r.moment;
    l.fn.yearDay = function (a) {
        var b = Math.floor(this._d / 864E5);
        return"undefined" === typeof a ? b : this.add({d: a - b})
    };
    ...
    "undefined" === typeof jQuery || "function" !== typeof document.addEventListener && !d.isIE8() || (jQuery.fn.kalendae = function (a) {
        this.each(function (b, d) {
            "INPUT" === d.tagName ? $(d).data("kalendae", new r.Input(d, a)) : $(d).data("kalendae", new r($.extend({}, {attachTo: d}, a)))
        });
        return this
    })
})();
